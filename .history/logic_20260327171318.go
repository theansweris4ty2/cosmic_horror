...
func (g *Game) Update() error {
	g.timer += 1
	g.monster.veloX = -1
	if g.timer%3 == 0 && g.monster.animationFrame > 0 {
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	opts.GeoM.Reset()
	screen.DrawImage(g.monster.monsterImages[0].SubImage(image.Rect(msrcX, msrcY, srcX+128, srcY+128)).(*ebiten.Image), opts)
