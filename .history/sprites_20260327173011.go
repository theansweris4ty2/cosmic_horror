...
func loadPlayerImages() ([]*ebiten.Image, *ebiten.Image, *ebiten.Image, *ebiten.Image) {
	...
	zombie_walk_left, _, err := ebitenutil.NewImageFromFile("zombie_walk_left.png")
	if err != nil {
		fmt.Println(err)
	}

	return []*ebiten.Image{playerImg1, playerImg2, playerImg3, playerImg4, playerImg5, playerImg6, playerImg7, playerImg8, playerImg9}, background, middleground, zombie_walk_left
}
