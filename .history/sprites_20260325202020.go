...
func loadPlayerImages() ([]*ebiten.Image, *ebiten.Image) {
	...
	background, _, err := ebitenutil.NewImageFromFile("background.jpg")
	if err != nil {
		fmt.Println(err)
	}
	return []*ebiten.Image{playerImg1, playerImg2, playerImg3, playerImg4, playerImg5, playerImg6, playerImg7}, background
}
